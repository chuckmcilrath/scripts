...
# wget -O dcmrefresh.sh https://raw.githubusercontent.com/chuckmcilrath/scripts/refs/heads/main/dcmrefresh.sh && chmod +x dcmrefresh.sh && (crontab -l 2>/dev/null | grep -v dcmrefresh; echo "*/15 * * * * /root/dcmrefresh.sh >/dev/null 2>&1") | crontab -
